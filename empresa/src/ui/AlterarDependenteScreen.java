...
import model.AlterarDependente;

public class AlterarDependenteScreen extends JInternalFrame implements ActionListener{
	// Cria uma label
	...
	private JLabel parentescoLabel = new JLabel("Novo Parentesco: ");
	...
	public AlterarDependenteScreen() throws Exception {
		/*
		 * Interface
		 */
		...
		this.setTitle("Alterar Dependente");
	...
	public void actionPerformed(ActionEvent e) {
		...
		AlterarDependente i;
		try {
			i = new AlterarDependente(empregado, nome, sexo, datanascimento, parentesco);
		} catch (Exception e1) {
			e1.printStackTrace();
		}
	}
