...
import model.RemoverDepartamento;

public class RemoverDepartamentoScreen extends JInternalFrame implements ActionListener{
	// Cria uma label
	private JLabel codigoLabel = new JLabel("Codigo do Departamento a ser Removido: ");
	...
	public RemoverDepartamentoScreen() throws Exception {
		/*
		 * Interface
		 */
		...
		this.setTitle("Remover Departamento");
	...
	public void actionPerformed(ActionEvent e) {
		...
		RemoverDepartamento r;
		try {
			r = new RemoverDepartamento(codigo);
		} catch (Exception e1) {
			e1.printStackTrace();
		}
	}
